...
function compass(props) {
    ...
    state.resetPosition = new SuperMap3D.Cartesian3.fromDegrees(
        110.60396458865515,
        34.54408834959379,
        30644793.325518917
    );
    ...
    function listener() {
        ...
        let x = -SuperMap3D.Math.toDegrees(heading);
   ...
   */
    ...
    function reduceCompass() {
        ...
        if (scene.camera.heading - SuperMap3D.Math.PI >= 0) {
    ...
    function zoomSpeed() {
        ...
        let distance = SuperMap3D.Cartesian3.distance(viewCenter, camera_position);
