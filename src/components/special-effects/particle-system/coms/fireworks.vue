...
let clickHandle, setIntervalList = [],particleSystemList = [];
scene.skyAtmosphere = new SuperMap3D.SkyAtmosphere();
scene.globe.show = false
scene.skyAtmosphere.show = false; //关闭大气

let sparkOneUrl = 'public/data/particle/babylon/sparkGravityOne.json';
let sparkTwoUrl = 'public/data/particle/babylon/sparkGravityTwo.json';
let sparkThreeUrl = 'public/data/particle/babylon/sparkGravityThree.json';
let sparkFourUrl = 'public/data/particle/babylon/sparkGravityFour.json';
