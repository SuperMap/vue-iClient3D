...
function scanEffect(props) {
    ...
    function init() {
        viewer.scene.scanEffect.color = SuperMap3D.Color.fromCssColorString(state.scanColor);
        ...
        viewer.scene.scanEffect.centerPostion = new SuperMap3D.Cartesian3.fromDegrees(0, 0, 0);
    };
